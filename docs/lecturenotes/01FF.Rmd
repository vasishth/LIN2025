---
title: "Preamble: Frequentis Foundations"
...
There is a correspondence between the **correctly computed** CI and the hypothesis testing procedure (see below).
...
Something close to 800 subjects would be needed to achieve 80% power.
